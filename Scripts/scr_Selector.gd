...
###########################################################
# This class controls the Selector and functions          #
# related to the selector.  This includes displaying the  #
# primary cursor, extending the cursor, collapsing the    #
# cursor, and selecting (and deselecting) Grid Cells      #
###########################################################
...
func _process(delta)->void:
	#If there is a current selection, freeze the cursor
